...
<head>
  ...
  <title>Universidad Siglo 21</title>
</head>
<body style="font-family: Arial, sans-serif; color: #333; background-color: #ffffff; padding: 20px;">
  ...
  <p>Desde hace una década somos la Universidad de Gestión Privada Más Elegida de Argentina. Los motivos?</p>
  <ul>
    <li><strong>Nuestra misión está alineada a tus objetivos</strong>: trabajamos para acompañarte en cada paso.</li>
    <li><strong>Lo último en Tecnología Educativa.</strong></li>
    <li><strong>Atención Permanente.</strong></li>
    <li><strong>Prácticas Profesionales.</strong></li>
    <li><strong>Convenios Institucionales</strong> con organizaciones nacionales e internacionales.</li>
    <li><strong>Reconocimiento de Equivalencias.</strong></li>
    <li><strong>Beneficios Arancelarios por Rendimiento Académico.</strong></li>
    <li><strong>Portal de Empleo.</strong></li>
    <li><strong>Aula Móvil</strong>: acceso a materiales desde donde estés.</li>
    <li><strong>Más de 300 CAUs</strong> en todo el país. Siempre cerca tuyo.</li>
  </ul>
  <p>Conocé el plan de estudios, perfil profesional y salida laboral <a href="${url}" target="_blank">haciendo clic aquí</a>.</p>
  <p><strong>Modalidades de Cursado:</strong></p>
  <ol>
    <li><strong>Educación Distribuida:</strong> Clases online + una teleclase semanal presencial.</li>
    <li><strong>Educación Distribuida Home:</strong> 100% online.</li>
    <li><strong>Presencial Distribuida (2025 en Mar del Plata):</strong> Telepresencialidad sincrónica + prácticas reales.</li>
  </ol>
  <p><strong>¡Gracias por tenernos en cuenta!</strong></p>
  <p>Consultas por WhatsApp: <a href="https://api.whatsapp.com/send?phone=5492235512665&text=Hola%21%20Quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%E2%80%A6" target="_blank" rel="noopener noreferrer">+54 9 223 551-2665</a>.</p>
  <p>Un saludo cordial,<br>Equipo Universidad Siglo 21</p>
</body>
</html>
`;
